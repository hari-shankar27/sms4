        ...
        <form method="POST">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <select name="event_type" required>
                        ...
                        <?php
                        $types = ["Academic", "Sports", "Cultural", "Meeting", "Other"];
                        foreach ($types as $type):
                        ?>
                            <option value="<?= $type ?>"
                                <?= $event['event_type'] === $type ? 'selected' : '' ?>>
                                <?= $type ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="time" name="start_time"
                           value="<?= htmlspecialchars($event['start_time']) ?>" required>
                </div>

                <div class="form-group">
                    <label>End Time</label>
                    <input type="time" name="end_time"
                           value="<?= htmlspecialchars($event['end_time']) ?>" required>
                </div>
            ...
            <div class="form-actions">
                <button type="submit" class="save-btn">
                    <i class="fa-solid fa-pen"></i> Update Event
                </button>
