...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (empty($title) || empty($description) || empty($notice_date)) {
        ...
        $stmt = $conn->prepare("INSERT INTO notices (title, description, notice_date) VALUES (?, ?, ?)");
    ...
    <main class="dashboard-content">
        ...
        <?php if (!empty($message)): ?>
            ...
            <div class="alert <?= htmlspecialchars($messageType) ?>">
                <i class="fa-solid
                    <?= $messageType === "success" ? "fa-circle-check" : "fa-circle-exclamation" ?>">
                </i>
            ...
            <form method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" id="title" name="title" placeholder="Enter notice title" maxlength="255" required
                        >
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" placeholder="Write your notice here..." rows="6" required
                    ></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="date" id="notice_date" name="notice_date" value="<?= date("Y-m-d") ?>" required>
                ...
                <div class="form-actions">
                    ...
                    <a href="/sms4/dashboard1.php" class="cancel-btn">
                        Cancel
                    </a>
