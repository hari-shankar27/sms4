...
<div class="container about-wrapper">
    ...
    <div class="overview">
        ...
        <div class="section-title">
            ...
            <p>
                Everything you need to manage academic information
    ...
    <div class="section-title">
        ...
        <p>
            Powerful features designed to make academic administration
    ...
    <div class="row g-4">
        ...
        <div class="col-md-4">
            ...
            <div class="feature-card">
                ...
                <p>
                    Easily add, update, view, and manage student information
        ...
        <div class="col-md-4">
            ...
            <div class="feature-card">
                ...
                <p>
                    Maintain teacher information and organize their
                    association with academic departments efficiently.
                </p>
        ...
        <div class="col-md-4">
            ...
            <div class="feature-card">
                ...
                <p>
                    Create, update, view, and manage department records
                    while keeping academic sections properly organized.
                </p>
        ...
        <div class="col-md-4">
            ...
            <div class="feature-card">
                ...
                <p>
                    Keep academic records structured and easily accessible,
                    reducing unnecessary paperwork and duplicate information.
                </p>
        ...
        <div class="col-md-4">
            ...
            <div class="feature-card">
                ...
                <p>
                    Authentication and controlled access help protect
                    important academic information from unauthorized users.
                </p>
        ...
        <div class="col-md-4">
            ...
            <div class="feature-card">
                ...
                <p>
                    A simple interface makes it easier for administrators
                    to perform everyday academic management tasks.
                </p>
    ...
    <div class="benefits-section">
        ...
        <div class="section-title">
            ...
            <p>
                Designed to improve productivity and simplify
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4">
                ...
                <div class="benefit-box">
                    ...
                    <p>
                        Quickly manage records without relying on
            ...
            <div class="col-md-4">
                ...
                <div class="benefit-box">
                    ...
                    <p>
                        Keep students, teachers, and departments
                        organized in a structured database.
                    </p>
            ...
            <div class="col-md-4">
                ...
                <div class="benefit-box">
                    ...
                    <p>
                        Replace traditional paperwork with a modern
                        digital approach to academic administration.
                    </p>
